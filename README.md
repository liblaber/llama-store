...
![Linting: pylint, Code style: black](https://github.com/jimbobbennett/llama-store/actions/workflows/lint.yml/badge.svg) ![pytest](https://github.com/jimbobbennett/llama-store/actions/workflows/test.yml/badge.svg)
...
The OpenAPI spec for this API is in the [`spec.json`](/spec.json) and [`spec.yaml`](/spec.yaml) files. These are autogenerated by a [GitHub action](/.github/workflows/update_spec.yaml). When a PR is raised, if the spec has changed, it is automatically updated into the PR.
